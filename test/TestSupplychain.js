...
contract("SupplyChain", function (accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
        ...
        const web3contract = new web3.eth.Contract(SupplyChain.abi, SupplyChain.address, {
            from: accounts[0],
        });

        web3contract.events.Harvested((err, res) => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
        ...
        web3contract.events.Processed((err, res) => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
        ...
        web3contract.events.Packed((err, res) => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
        ...
        web3contract.events.ForSale((err, res) => {
            eventEmitted = true;
        });
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
        ...
        web3contract.events.Sold((err, res) => {
            eventEmitted = true;
        });
        ...
        await supplyChain.packItem(upc, { from: accounts[1] });
        await supplyChain.sellItem(upc, productPrice, { from: accounts[1] });
        await supplyChain.buyItem(upc, { from: accounts[2], value: 2 * productPrice });

        const resultBufferOne = await supplyChain.fetchItemBufferOne.call(upc);
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc);

        assert.equal(resultBufferOne.ownerID, accounts[2], "Error: wrong ownerID");
        assert.equal(resultBufferTwo.distributorID, accounts[2], "Error: wrong distributorID");
